...
Use this skill when:
- Reviewing a PR or code change in the project
...
- **Handle OOM with exceptions or fail-fast, never asserts.** Use `ThrowOutOfMemory` not asserts. In interpreter loops, use `nothrow new` and check for null.
...
- **Use modern xUnit patterns for xUnit-based tests.**
